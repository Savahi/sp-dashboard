...
<div class='header' id='header'>
	...
	<div class='page-details' id='pageDetails'>
		<div class='page-name' id='pageName'>SPIDER PROJECT</div>
	</div>
	<div class='page-user' id='pageUser'>
	</div>
</div>
...
<div class='content'>
	<div data-pageid='main'>
		<div style='width:100%; box-sizing:border-box; padding:24px;'>
			<div id='dashboardContainer' style='position:absolute; border:1px solid gray; overflow:auto; left:0; top:0; width:100%; height:100%;'>
			</div>
		</div>
	</div>
